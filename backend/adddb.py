...
with app.app_context():
    ...
    # Nhân viên
    nhan_viens = [
        NhanVien(ho_ten="Nguyễn Chí Thanh", ngay_sinh=date(2003, 7, 25), gioi_tinh="Nam",
        ...
        NhanVien(ho_ten="Trần Thị B", ngay_sinh=date(1990, 8, 12), gioi_tinh="Nữ",
        ...
        NhanVien(ho_ten="Nguyễn Văn A", ngay_sinh=date(1995, 5, 20), gioi_tinh="Nam",
    ...
    # Lương
    luongs = [
        Luong(nhan_vien_id=nv.id, thang=date(2025, 4, 1), luong_co_ban=10_000_000,
              phu_cap=2_000_000, khau_tru=1_000_000)
        for nv in nhan_viens
    ]
    ...
    # Đánh giá
    danh_gias = [
        DanhGia(nhan_vien_id=nv.id, thoi_gian=date(2025, 4, 1), diem_so=8.0 + idx,
                nhan_xet="Hiệu suất tốt" if idx % 2 == 0 else "Cần cải thiện")
        for idx, nv in enumerate(nhan_viens)
    ]
